    ...
    <div className="config-list platform-config-list">
      ...
      {platforms.map((platform, index) => (
        <div className="platform-config-row" key={platformEntities[index]?.id || index}>
          ...
          <button type="button" className="platform-subplatform-button" title={`Configurar subplataformas de ${platform || "esta plataforma"}`} onClick={() => openModal(platform)}><Settings2 size={14} /> Subplataformas</button>
