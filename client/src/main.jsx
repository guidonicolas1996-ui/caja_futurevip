...
function MiniUsersPanel({ config, boxes, activeBoxId, onConfigChange, onNotify }) {
  ...
  return <section className="panel mini-users-panel">
    <div className="section-head mini-users-head"><div className="section-title"><Users size={18} /><div><h2>Usuarios</h2></div></div><button className="config-add mini-users-add" type="button" title="Dar de alta usuario" onClick={() => { setNewUser({ name: "", phone: "", titular: "", boxId: activeBoxId }); setNewUserOpen(true); }}><UserPlus size={15} /> Nuevo usuario</button></div>
