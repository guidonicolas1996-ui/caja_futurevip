...
export default function CajaReportCardV3({ data, snapshotRef }) {
  ...
  const bonusSlots = Array.from({ length: 4 }, (_, index) => {
    ...
    return { label: `${String(slotStart).padStart(2, "0")}:00 - ${String(slotEnd).padStart(2, "0")}:00`, items };
  });
